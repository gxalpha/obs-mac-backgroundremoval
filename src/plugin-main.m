...
static obs_properties_t *vision_properties(void *)
{
	...
	obs_property_t *list = obs_properties_add_list(props, "quality", obs_module_text("Quality"),
						       OBS_COMBO_TYPE_LIST, OBS_COMBO_FORMAT_INT);
	// "Accurate" is currently broken. The resulting mask is fine, but the result when rendered isn't.
